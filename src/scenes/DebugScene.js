...
export default class DebugScene extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        // <----------------
            ...
            if (MMRPG.debug.debugObjects){ delete MMRPG.debug.debugObjects; }
            MMRPG.debug.debugObjects = $debugObjects;
            ...
            MMRPG.debug.customObjects = $customObjects;
